...
public class NumeroModel {
	...
	/**
	 * Metodo per efettuare un tentativo
	 * @param t il tentativo
	 * @return 1 se il tentativo è troppo alto,-1 se è troppo basso,0 se è indovinato
	 */
	public int tentativo(int t) {
		
		//controllo se la partita è in gioco
		if(!inGioco) {
			throw new IllegalStateException("La partita è terminata!");
		}
		
		//controllare se l'input è nel rangecorretto
